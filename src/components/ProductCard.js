...
<div className="card-div card">
    ...
    <div className="lwr-card-div">
        ...
        <p className="card-desc">{props.data.description.length>150 && !readMore ? `${props.data.description.substring(0,149)}...` :  props.data.description}</p>
{props.data.description.length>150 && !readMore ? 
